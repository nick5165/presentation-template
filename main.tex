\documentclass[aspectratio=169]{beamer} % Формат 16:9 как на ваших скриншотах
...
\date{} % Пустая дата, так как на исходном слайде её нет
...
\begin{tabular}{|p{4.5cm}|c|c|c|c|}
    ...
    gpt-oss-20b + BGE-M3 + Reranker & 0,76 & 0,69 & 0,46 &